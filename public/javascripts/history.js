    ...
    function setup(selecterObjects) {
        ...
        selecters.$dialog.setup = function (historyInfoArray, isDiffSupport) {
            ...
            historyInfoArray.forEach(function (historyInfo) {
                ...
                var $tableRow = $('<tr>');
                gspecv.util.appendTableRowCell($tableRow, $checkBox, $('<a href=download_with_version/' + historyInfo._id + '></a>').text(historyInfo.name), historyInfo.version, historyInfo.comment, historyInfo.user_name, historyInfo.commit_time);
