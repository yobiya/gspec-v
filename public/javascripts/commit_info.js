    ...
    function find(option) {
        ...
        function addEditTag(fileInfo) {
            (function () {
                ...
                gspecv.util.post('add_tag', { commit_document_id: fileInfo._id, tag_names: editTagNames }, function (data) {
        ...
        $.post('find', option, function (fileInfos) {
            ...
            fileInfos.forEach(function (fileInfo) {
                ...
                gspecv.util.appendTableRowCell($tableRow, createDropdownMenu(fileInfo), notViewVersionCount || '', $editAndFileDownload, $downloadFileName, createTagCell(fileInfo.tag_names), fileInfo.version, fileInfo.comment, fileInfo.commit_user_name, fileInfo.commit_time);
